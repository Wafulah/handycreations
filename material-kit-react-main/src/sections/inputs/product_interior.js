...
export const InteriorProduct = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/interior-design-tags/`)
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`${process.env.NEXT_PUBLIC_BASE_URL}/api/interior-designs/`, formData, {
        headers: {
